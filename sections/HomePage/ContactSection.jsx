          ...
          <form onSubmit={handleSubmit}>
            <GridContainer>
              ...
              <GridItem>
                ...
                />
                {content.length < 80 && (
                  <span className={classes.textCount}>Il vous reste {80 - content.length} caractères à écrire</span>
                )}
              </GridItem>
              <GridContainer justify="center">
                <GridItem xs={12} sm={12} md={4} className={classes.textCenter}>
                  <Button color="primary" type="submit" disabled={isLoading || content.length < 80}>
                    Envoyer
                  </Button>
                </GridItem>
              </GridContainer>
