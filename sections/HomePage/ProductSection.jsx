...
import productStyle from "static/jss/la-flamme-connectee/views/homePageSections/productStyle";
      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={8} className={classes.gridItem}>
          ...
          <h5 className={classes.description}>
            Avec le système <strong>Flamme Connect</strong>, programmez l'allumage de votre poêle ou insert en votre
            absence.
            <br />
