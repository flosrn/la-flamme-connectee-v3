        ...
        <GridItem xs={12} sm={12} md={6} lg={6}>
          ...
          <Card plain id="animateUp">
            ...
            <CardBody>
              <GridItem xs={10} md={12} lg={10} className={classes.itemGrid}>
                <p className={classes.description}>
                  Secrétaire de direction de formation, Marie-Laure a toujours épaulé et soutenu son mari Patrick dans
            ...
            <CardBody>
              <GridItem xs={10} md={6} lg={10} className={classes.itemGrid}>
                <p className={classes.description}>
                  ...
                  Flamme Connectée. Florian s'occupe aussi des stratégies de communication à adopter pour faire vivre
                  l'image de la marque à travers les réseaux sociaux.
                </p>
              </GridItem>
            </CardBody>
            {/* <Box className={classes.justifyCenter}> */}
