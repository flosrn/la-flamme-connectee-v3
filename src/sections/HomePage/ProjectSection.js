...
function ProjectSection() {
  ...
  return (
    <LayoutSection title="Notre histoire" id="projects">
      <GridItem xs={10} sm={10} md={8} className={classes.textContainer}>
        <p>
          Tout commence en <strong>2013</strong> lorsque Patrick et Marie-Laure investissent dans un poêle à bois pour
          leur habitation de 160m².
        </p>
        <p>
          Très vite, souhaitant faire du bois son unique source de chauffage et se passer totalement de sa chaudière au
          fioul, Patrick met au point son premier prototype d’allumage de poêle à bois à distance. Il utilise alors le
        ...
        <p>
          En <strong>2019</strong>, Patrick dépose un brevet et ils décident, avec Marie-Laure son épouse, de présenter
          l’invention au célèbre concours Lépine à Paris dont ils repartent médaillés d’Argent.
        </p>

        <p>
          Voyant le projet se concrétiser mais tout de même stagner, Florian, développeur de métier, décide de coder de
          A à Z un site de e-commerce afin de donner de la visibilité à l’invention de son père.
        </p>
        <p>
          <strong>C'est comme cela que La Flamme Connectée est née !</strong>
        </p>
        <p>
          Dans le même temps, sont trouvés les noms du boitier domotique : Le Flam’connect, et le nom des allume-feux :
          Les Volcano’connect. Mélanie, la compagne de Florian, s’attèle quant-à-elle à faire connaître La Flamme
          Connectée sur les réseaux sociaux. Convaincue du potentiel commercial du système, elle l’épaule concernant les
          différentes stratégies de communication et la relation client.
        </p>
        <p>
          En <strong>2020</strong>, Florian décide de reprendre les rennes de ce qu’a commencé à construire son père et
          poursuivre l’aventure. Il devient alors actionnaire principal de la société et souhaite la faire évoluer afin
          de produire à plus grande échelle le premier système d’allumage de foyer bois connecté au monde.
        </p>
        {/* <Fade spy={isDesktop} bottom cascade ssrFadeout> */}
        {/* <div className={classes.projectText}> */}
        {/* <h5 className={classes.description}> */}
        {/*  Nous sommes propriétaire depuis 2000 d'une maison de 160 m² en banlieu toulousaine et nous consommions 1400 */}
        {/*  L/an de fioul pour avoir une température d'environ 17 degrès. */}
        {/*  <br /> */}
        {/*  <br /> */}
        {/* </h5> */}
        {/* <h5 className={classes.description}> */}
        ...
        {/*  mandatons une société qui réalise une recherche d’antériorité mondiale, qui confirme que le système n’existe */}
        {/*  pas. */}
        {/*  <br /> */}
        {/*  <br /> */}
        {/* </h5> */}
        ...
        {/* </h5> */}
        {/* <h5 className={classes.description}> */}
        {/*  <strong>C'est en 2018</strong> que mon fils Florian m'incite à acheter une imprimante 3D, ce qui m'a offert */}
        {/*  des possibilitées nouvelles. */}
        {/*  <br /> */}
        {/*  <br /> */}
        {/* </h5> */}
        {/* <h5 className={classes.description}> */}
        {/*  <strong>Avril 2019</strong>, je dépose un Brevet et je décide de présenter mon invention au Concours Lépine */}
        {/*  de Paris en tant qu'inventeur. Ayant remporté une Médaille d’Argent et un franc succès auprès du public et */}
        {/*  des professionnels du chauffage au bois, je décide de retravailler mon produit pour le rendre plus léger, */}
        {/*  plus design et plus convivial, afin de le produire personnellement et le commercialiser */}
        {/*  <br /> */}
        {/*  <br /> */}
        {/* </h5> */}
        {/* <h5 className={classes.description}> */}
