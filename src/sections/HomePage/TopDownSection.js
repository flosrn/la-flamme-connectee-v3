...
function TopDownSection() {
  ...
  return (
    <LayoutSection
      title="La technique de l'allumage inversé"
      id="topDown"
      desc={[
        {
          text: (
            <span>
              ...
              , moins polluante, qui permet également une combustion plus progressive. Le principe est simple et
              similaire à l’allumage d’une bougie : le feu est allumé en haut de la pyramide de bûches et il brûle vers
              le bas.
            </span>
          )
        }
    ...
    >
      <GridItem xs={11} sm={8} md={8} lg={7} center className={classes.gridImg}>
        <img
      ...
      <GridItem xs={12} sm={12} md={12} lg={5} className={classes.gridItemBottom}>
        <InfoArea
